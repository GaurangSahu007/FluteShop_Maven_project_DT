...
//		mvc.addObject("mylist",categeries);
	...
	@RequestMapping(value ="/adminusershow",method=RequestMethod.GET)
	public ModelAndView showUserdetailsadmin() 
	{	
		
		ModelAndView mvc=new ModelAndView("UserDetailsViewAdmin","userdetails",new UserDetails());
//		String categeries=cdao.Retrive();
//		mvc.addObject("mylist",categeries);
		return mvc;
	}
