...
<a href="index.jsp"><img src="resources/My_Design/flutelogo.jpe" class="img-responsive" alt="Cinque Terre" width="200" height="100"/>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="index.jsp">Flute Shop</a>
    </div>
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">ManageCategory<span class="caret"></span></a>
        <ul class="dropdown-menu">
         ...
         href="#">ManageUser<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="adminusershow">AddUser</a></li>
